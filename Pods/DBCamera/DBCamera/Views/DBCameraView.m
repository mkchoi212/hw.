...
- (UIButton *) cameraButton
{
    if ( !_cameraButton ) {
        ...
        [_cameraButton setImage:[[UIImage imageNamed:@"capture_flip"] tintImageWithColor:self.tintColor] forState:UIControlStateNormal];
        [_cameraButton setImage:[[UIImage imageNamed:@"capture_flip_active"] tintImageWithColor:self.selectedTintColor] forState:UIControlStateSelected];
        [_cameraButton setFrame:(CGRect){ 25, 17.5f, 40, 30 }];
...
- (CALayer *) focusBox
{
    if ( !_focusBox ) {
        ...
        [_focusBox setBorderWidth:4.f];
        [_focusBox setBorderColor:[RGBColor(0xFEF366, 1) CGColor]];
...
- (CALayer *) exposeBox
{
    if ( !_exposeBox ) {
        ...
        [_exposeBox setBorderColor:(__bridge CGColorRef)([UIColor clearColor])];
